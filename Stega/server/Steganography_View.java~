...
public class Steganography_View extends JFrame
{
	...
	private JButton		saveButton,openButton,connectButton,encodeButton,decodeButton,aboutButton;
	...
	public Steganography_View(String name)
	{
		...
		file.addSeparator();
		JMenu More = new JMenu("More");	file.setMnemonic('M');
		about = new JMenuItem("About"); about.setMnemonic('A'); More.add(about);
		More.addSeparator();
	...
	public JButton		getAButton()	{ return aboutButton;		}
